...
import { Box, Text, Hide, Flex, Image, Button, Heading, SimpleGrid, IconButton } from "@chakra-ui/react";
...
function SmapleNextArrow(props) {
  ...
  return (
    <div className={className} style={{ ...style, display: "block", color: "black", right: "-8px" }} onClick={onClick}>
...
const SingleImage = ({ el }) => {
  ...
  const ImageChangeOnMouseOverr = () => {
    return (
      <div>
        <ImageToggleOnMouseOver primaryImg={img1} secondaryImg={img2} alt="image1" />
      </div>
    );
  };
  return (
    <Flex direction={"column"}>
      <Flex position={"relative"} onMouseOver={over} onMouseOut={out}>
        ...
        <IconButton
          ...
          right={"10px"}
        />
        <Button height={"20px"} width={"40px"} borderRadius={"20px"} position={"absolute"} bgColor={"#da3f3f"} top={"10px"} left={"10px"}>
  ...
  return (
    <div>
      <SimpleGrid columns={[1, 1, 1]} px={"21px"} spacing={"21px"}>
        <Box>
          <Image src="https://cdn.shopify.com/s/files/1/0677/1464/6315/files/10_ARTIST_DESKTOP5.jpg?v=1676618119&width=1500" alt="koovs-big_logo" />
        </Box>
      </SimpleGrid>
      <Box ml="80px" mt="20px">
      ...
      <SimpleGrid columns={[1, 1, 2]} px={"21px"} spacing={"21px"}>
        <Box>
          <Image src="https://cdn.shopify.com/s/files/1/0677/1464/6315/files/KOOVS_20OCT22-1007.jpg?v=1667990812&width=720" alt="featured_brand_logo1" />
          <Text as="h3" color={"black"} fontWeight="600">
            Essentials by Koovs
          </Text>
        </Box>
        <Box>
          <Image src="https://cdn.shopify.com/s/files/1/0677/1464/6315/files/KOOVS_20OCT22-3213-141.jpg?v=1667995128&width=720" alt="featured_brand_logo2" />
          <Text as="h3" color={"black"} fontWeight="600">
            Koovs
          </Text>
        </Box>
